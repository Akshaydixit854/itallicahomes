...
class PropertiesController extends Controller
{
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $property->name = trim($request->get('name'));
        $property->name_in_italian = $request->get('name_italian') != '' ? $request->get('name_italian') : $request->get('name');
        $property->name_in_german = $request->get('name_german') != '' ? $request->get('name_german') : $request->get('name');
    ...
    public function edit($id)
    {
        ...
        $agencies = Agent::all();
        return view('admin.properties.edit', compact('agencies','language_line_short_desc','language_line_title','areas','language_line','property','locations','types','settings','conditions','offers','destinations','amenities','regions','selected_ameneties','gallery_images'));
    }
