		...
		<tr>
			...
			<!--	<table width="100%" cellpadding="0" bgcolor="#ffffff" cellspacing="0" border="0" align="center">
				...
				<table width="100%" cellpadding="0" bgcolor="#F0F0F0" cellspacing="0" border="0" align="center">
					...
					<!--	<tr>
							<td style="padding:20px; text-align: center;">
								<a href="https://www.facebook.com/italicahomes/"><img style="width: 18px; margin: 0 13px;" src="<?php echo e(asset('images/contact_enquiry/img1.png')); ?>" alt="facebook" /></a>
								...
								<a href="https://twitter.com/livingartIT"><img style="width: 33px; margin: 0 13px;" src="<?php echo e(asset('images/contact_enquiry/img4.png')); ?>" alt="twitter" /></a>
