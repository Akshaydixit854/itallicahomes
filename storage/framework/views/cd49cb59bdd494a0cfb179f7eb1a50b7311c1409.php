...
?>
    ...
    <div class="wrapper">
        <?php if($lang1 == 'en'): ?>
          <form id="form_validation" method="POST" action="<?php echo e(url(''.$srch.'')); ?>">
        <?php else: ?>
          <form id="form_validation" method="POST" action="<?php echo e(url(''.$lang1.'')); ?>/<?php echo e($srch); ?>">
        <?php endif; ?>
...
<?php $__env->startSection('custom-js'); ?>
    ...
    <script src=<?php echo e(asset("ui/js/bootstrap.min.js")); ?>></script>
     <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCzURfeh1OY6xV6dnCSF6-5tsk1EpGtd1o"></script> -->
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCzURfeh1OY6xV6dnCSF6-5tsk1EpGtd1o&callback=initMap" type="text/javascript"></script>
