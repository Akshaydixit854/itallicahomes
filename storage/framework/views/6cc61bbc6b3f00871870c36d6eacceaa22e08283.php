                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>Blog Posts</h2>
                            <a href="<?php echo e(route('add-post.create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                    ...
                                    <tbody>
                                        <?php if(count($posts) > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-prev-img"><img src=<?php echo e(asset("images/post-cover-images/" . $row->cover_image)); ?> width="200px" height="100px"></td>
                                            	...
                                            	<td>
                                            		<a href="<?php echo e(route('add-post.edit',$row->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                </td>
                                                <td>
                                                    <form id="delete_form" class="display-inline delete_form_<?php echo e($row->id); ?>" method="POST" action="<?php echo e(route('add-post.destroy',$row->id)); ?>">
