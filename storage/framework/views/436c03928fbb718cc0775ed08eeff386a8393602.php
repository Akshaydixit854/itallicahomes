...
<title><?php echo e($property->name); ?></title>
<?php
    if($property){
    $meta_descr = strip_tags($property->detail_description);
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="testimonial-slider" class="owl-carousel custom-slider-arrow">
                                    ...
                                    <?php else: ?> <?php echo e(url(''.$lang1.'')); ?>/properties/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id)))); ?><?php endif; ?>" class=""><img src=<?php echo e(asset("/images/cover-images/".$related_property->cover_image_name)); ?>></a></span>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(url(''.$lang1.'')); ?>/properties/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$related_property->id)))); ?>" class="properties-link"><?php echo app('translator')->getFromJson('app.read_more'); ?></a>
                                    <?php endif; ?>
...
<!--        <?php echo e(Html::script('ui/js/jquery.googlemap.js')); ?> -->
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC808NpIO-MZ_C-nXv21zGFDKC1OUm_MkQ&callback=initMap" type="text/javascript"></script>
      ...
      /*  console.log(locations);*/
        ...
        function initMap() {
            ...
            for (i = 0; i < locations.length; i++) {
              ...
              con+='<i class="properties-price-doller">'+locations[i]['price']+'</i></div> <div class="map-hover-properties-btn"><a href="#" onclick="sowjin()" data-toggle="modal" data-target="#quick-map-modal-'+locations[i]['id']+'" class="quick-btn"><?php echo app('translator')->getFromJson('app.quick_view'); ?></a>';
  ...
  /*            console.log(i);*/
    ...
    <script>
        ...
        $('.btnShare').click(function(){
            ...
            var URL ='';
            if(lang1 == 'en' ){
                var URL = "<?php echo e(url('')); ?>/properties/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id)))); ?>";
            }else {

            var URL = "<?php echo e(url('')); ?>/"+lang1+"/properties/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id)))); ?>";
            }
