                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            ...
                            <a href="<?php echo e(url('')); ?>/admin/owner_create" class="btn btn-info m-t-15 waves-effect">Add New</a>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        <?php if(count($OwnerService) > 0): ?>
                                        	<?php $__currentLoopData = $OwnerService; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                            	<td><?php echo e($key+1); ?></td>
                                                <td class="table-prev-img"><img src=<?php echo e(asset("images/ownerService-cover-images/" . $row->cover_image)); ?> width="200px" height="100px"></td>
                                                <td><?php echo substr($row->content,500); ?> </td>
                                                <td><?php echo e($row->published_by); ?> </td>
                                                <td><?php echo e($row->created_at); ?> </td>
                                                <td><?php if($row->is_available == 1): ?><?php echo e('Online'); ?> <?php else: ?> <?php echo e('Offline'); ?> <?php endif; ?></td>
                                            	<td>
                                            		<a href="<?php echo e(url('')); ?>/admin/owner_edit/<?php echo e($row->id); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                </td>
                                                <td>
                                                    <form id="delete_form" class="display-inline delete_form_<?php echo e($row->id); ?>" method="POST" action="<?php echo e(url('')); ?>/admin/owner_delete/<?php echo e($row->id); ?>">
