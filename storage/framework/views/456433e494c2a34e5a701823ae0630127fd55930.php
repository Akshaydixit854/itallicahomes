                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>Privacy Policy</h2>
                            <a href="<?php echo e(url('/admin/privacy_policy/create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        <?php if($PrivacyPolicys): ?>
                                            <tr>
                                            	<td><?php echo e('1'); ?></td>
                                                <td class="table-tit"><?php echo $PrivacyPolicys->privacy_policy; ?> </td>
                                            	<td>
                                            	    <a href="<?php echo e(url('/admin/privacy_policy/edit',$PrivacyPolicys->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                    <form class="display-inline" id="delete_form" method="POST" action="<?php echo e(url('/admin/privacy_policy/delete',$PrivacyPolicys->id)); ?>">
