<?php $__env->startSection('custom-css'); ?>
    <title><?php echo e(__('app.owner_services')); ?></title>
<?php
    if($OwnerService ){
...
?>
    ...
    <div class="wrapper">
        <div class="about-page-banner">
            <img src=<?php echo e(asset("images/ownerService-cover-images/". $OwnerService->cover_image)); ?> alt="" />
        </div>
        ...
        <div class="about-us-text-wrapper">
            <div class="main-container-wrapper">
                <span class="inner-blog-heading">
                    <input type="hidden" name="post_id" id="post_id" value="<?php echo e($OwnerService->id); ?>">
            <input type="hidden" name="post_img" id="post_img" value=<?php echo e(asset("images/post-cover-images/". $OwnerService->cover_image)); ?>><a href="javascript:history.back()"><svg width="18px" height="17px" viewBox="0 0 18 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            </svg></a><?php echo app('translator')->getFromJson('app.owner_services'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="inner-blog-content" id="inner-blog-content">
                                  <?php if(\Lang::has('ownerServiceDesc.ownerService_description_'.$OwnerService->id)): ?>
                                    <?php echo trans('ownerServiceDesc.ownerService_description_'.$OwnerService->id); ?>

                                <?php else: ?>
                                    <?php echo $OwnerService->content; ?>
