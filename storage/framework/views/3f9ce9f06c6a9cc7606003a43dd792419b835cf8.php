                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>New Location</h2>
                            <a href="<?php echo e(route('add-area.create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        <?php if(count($areas) > 0): ?>
                                        	<?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                            	<td><?php echo e($key+1); ?></td>
                                                <td><?php echo e($row->area_name); ?> </td>
                                                <td><?php echo e($row->description); ?> </td>
                                            	<td>
                                            	    <a href="<?php echo e(route('add-area.edit',$row->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                    <form class="display-inline delete_form_<?php echo e($row->id); ?>" id="delete_form" method="POST" action="<?php echo e(route('add-area.destroy',$row->id)); ?>">
