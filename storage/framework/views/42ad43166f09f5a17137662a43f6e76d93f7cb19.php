        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <p>Property ID - <?php echo e($property->property_id); ?></p>
                    <p>Property Name - <?php echo e($property->name); ?></p>
                    <p>Name - <?php echo e($contact_faqs->name); ?></p>
                    <p>Email - <?php echo e($contact_faqs->email); ?></p>
                    <p>Phone - <?php echo e($contact_faqs->phone); ?></p>
                    <p>Address - <?php echo e($contact_faqs->address); ?></p>
                    <p>Message - <?php echo e($contact_faqs->message); ?></p>
                </div>
            </div>
        </div>
        <!-- #END# Vertical Layout -->
