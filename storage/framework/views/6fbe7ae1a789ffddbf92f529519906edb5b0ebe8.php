            ...
            <div class="main-container-wrapper">
                ...
                <div class="wrapper">
                            ...
                            <div class="col-md-4">
                                <div class="properties-list-wrapper home-pro equal-height">
                                    <div class="properties-pic-section">
                                        <span><a href="<?php echo e(url('')); ?>/properties/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id)))); ?>" class="properties-link">
                                            <img class="prop_images" id="prop_images_<?php echo e($property->id); ?>" data-main-id="<?php echo e($property->id); ?>" src=<?php echo e(asset("/images/cover-images/".$property->cover_image_name)); ?>></a></span>
                                    ...
                                    <div class="properties-name">
                                        <?php if(\Lang::has('property.property_title_'.$property->id)): ?>
                                            <span><em><?php echo e((new \App\Services\PropertyService)->truncate(trans('property.property_title_'.$property->id))); ?></em><i><a class="heart-fav" id="heart-fav_<?php echo e($property->id); ?>" data-main-id="<?php echo e($property->id); ?>" href="/favourite/<?php echo e($property->id); ?>"><?php echo (new \App\Services\PropertyService)->checkFav($property->id); ?></a></i></span>
                                        <?php else: ?>
                                            <span><em><?php echo e((new \App\Services\PropertyService)->truncate($property->name)); ?></em><i><a  class="heart-fav" id="heart-fav_<?php echo e($property->id); ?>" data-main-id="<?php echo e($property->id); ?>"  href="/favourite/<?php echo e($property->id); ?>"><?php echo (new \App\Services\PropertyService)->checkFav($property->id); ?></a></i></span>
                                        <?php endif; ?>
                    ...
                    <div class="properties-view-all">
                        <a href="<?php echo e(url('')); ?>/search">View All</a>
                    </div>
                </div>
            </div>
        </div>
