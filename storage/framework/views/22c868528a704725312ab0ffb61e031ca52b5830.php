<!-- Sidebar scroll-->
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="<?php echo e(asset('images/users/profile.jpg')); ?>" alt="user" />
                        <!-- this is blinking heartbit-->
                        <div class="notify setpos"> <span class="heartbit"></span> <span class="point"></span> </div>
                    </div>
                    <!-- User profile text-->
                    <div class="profile-text">
                        <h5><?php echo e(ucwords(Auth::user()->name)); ?></h5>
                        ...
                        <div class="dropdown-menu animated flipInY">
                            <!-- text-->
                            <a href="<?php echo e(route('profile.index')); ?>" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                            <!-- text-->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard <!-- <span class="label label-rouded label-themecolor pull-right">4</span></span> --></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('')); ?>/admin"><i class="fa fa-eye"></i> Show Statistics </a></li>
                        ...
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="ti ti-user"></i><span class="hide-menu">Manage Users</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo e(url('admin/users')); ?>"><i class="fa fa-users"></i> Users</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Properties</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('admin/properties')); ?>"><i class="fa fa-eye"></i> View All Properties</a></li>
                                <li><a href="<?php echo e(url('admin/properties/create')); ?>"><i class="fa fa-plus"></i> Create a Property</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Property Setting</span></a>
                           <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(route('add-offer.index')); ?>"><i class="fa fa-eye"></i> View</a></li>
                                    <li><a href="<?php echo e(route('add-offer.create')); ?>"><i class="fa fa-plus"></i> Add New</a></li>
                                </ul>
                            </ul>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(route('add-condition.index')); ?>"><i class="fa fa-eye"></i> View</a></li>
                                    <li><a href="<?php echo e(route('add-condition.create')); ?>"><i class="fa fa-plus"></i> Add New</a></li>
                                </ul>
                            </ul>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(route('add-region.index')); ?>"><i class="fa fa-eye"></i> View</a></li>
                                    <li><a href="<?php echo e(route('add-region.create')); ?>"><i class="fa fa-plus"></i> Add New</a></li>
                                </ul>
                            </ul>
                             <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(route('add-destination.index')); ?>"><i class="fa fa-eye"></i> View</a></li>
                                    <li><a href="<?php echo e(route('add-destination.create')); ?>"><i class="fa fa-plus"></i> Add New</a></li>
                                </ul>
                            </ul>
                             <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(route('add-property-types.index')); ?>"><i class="fa fa-eye"></i> View</a></li>
                                    <li><a href="<?php echo e(route('add-property-types.create')); ?>"><i class="fa fa-plus"></i> Add New</a></li>
                                </ul>
                            </ul>
                             <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(route('add-amenities.index')); ?>"><i class="fa fa-eye"></i> View</a></li>
                                    <li><a href="<?php echo e(route('add-amenities.create')); ?>"><i class="fa fa-plus"></i> Add New</a></li>
                                </ul>
                            </ul>
                             <ul aria-expanded="false" class="collapse">
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(route('add-agency.index')); ?>"><i class="fa fa-eye"></i> View</a></li>
                                    <li><a href="<?php echo e(route('add-agency.create')); ?>"><i class="fa fa-plus"></i> Add New</a></li>
                                </ul>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-message"></i><span class="hide-menu">Blog Posts</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('add-post.index')); ?>"><i class="fa fa-eye"></i> View All</a></li>
                                <li><a href="<?php echo e(route('add-post.create')); ?>"><i class="fa fa-plus"></i> Create New</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-calendar-question"></i><span class="hide-menu">FAQ's</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('add-faq.index')); ?>"><i class="fa fa-eye"></i> View All</a></li>
                                <li><a href="<?php echo e(route('add-faq.create')); ?>"><i class="fa fa-plus"></i> Create New</a></li>
                            </ul>
                        </li>
                         <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-calendar-question"></i><span class="hide-menu">Testimonials</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('add-testimonial.index')); ?>"><i class="fa fa-eye"></i> View All</a></li>
                                <li><a href="<?php echo e(route('add-testimonial.create')); ?>"><i class="fa fa-plus"></i> Create New</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">Inbox</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('')); ?>/admin/inbox"><i class="fa fa-eyes"></i> View All Messages</a></li>
                                <li><a href="<?php echo e(url('')); ?>/admin/inbox/unread">Unread</a></li>
                        ...
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-grid"></i><span class="hide-menu">Services</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="ti ti-user"></i><span class="hide-menu"> Owner</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="<?php echo e(url('')); ?>/admin/owner"><i class="fa fa-eye"></i> View</a></li>
                                    </ul>
                                <li><a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="ti ti-user"></i><span class="hide-menu"> Buyer</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="<?php echo e(url('')); ?>/admin/buyer"><i class="fa fa-eye"></i> View</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-grid"></i><span class="hide-menu">Meta Tags</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('add-meta-tags.index')); ?>"><i class="fa fa-eye"></i> Title & Description</a></li>
                                <li><a href="<?php echo e(route('add-meta-tags.create')); ?>"><i class="fa fa-plus"></i> Add</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">Setting</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('')); ?>/admin/setting/create">Configuration</a></li>
