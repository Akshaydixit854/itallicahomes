        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST" action="<?php echo e(url('/admin/privacy_policy/update').'/'.$PrivacyPolicy->id); ?>" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group ">
                                            <textarea id="ckeditor" class="detailed_description"  name="privacy_policy" ><?php echo e($PrivacyPolicy->privacy_policy); ?></textarea>
                                        <?php if($errors->has('detail_description')): ?>
                                            <label id="name-error" class="error" for="detail_description"><?php echo e($errors->first('privacy_policy')); ?></label>
                                        <?php endif; ?>
                                    </div>
                                    <label class="form-label">Description In Italian</label>
                                    <div class="form-group ">
                                        <div class="form-line">
                                            <textarea id="ckeditor2" name="italian"><?php echo e($PrivacyPolicy->italian); ?></textarea>
                                        </div>
                                    </div>
                                    <label class="form-label">Description In German</label>
                                    <div class="form-group ">
                                        <div class="form-line">
                                            <textarea id="ckeditor3" name="german"><?php echo e($PrivacyPolicy->german); ?></textarea>
                                        </div>
