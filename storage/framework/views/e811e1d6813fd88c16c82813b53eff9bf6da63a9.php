                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>Property Enquiry Details</h2>
                            <ul class="header-dropdown m-r--5">
                            </ul>
                        </div>                                          
                        <div class="contact-card">
                            <p><b>PropertyId</b> - <?php echo e($PropertyEnquiry->property_id); ?></p>
                            <p><b>User Name</b> - <?php echo e($PropertyEnquiry->name); ?></p>
                            <p><b>Email</b> - <?php echo e($PropertyEnquiry->email); ?></p>
                            <p><b>Phone</b> - <?php echo e($PropertyEnquiry->phone); ?></p>
                            <p><b>Address</b> - <?php echo e($PropertyEnquiry->address); ?></p>
                            <p><b>Message</b> - <?php echo e($PropertyEnquiry->message); ?></p>
                        </div>
