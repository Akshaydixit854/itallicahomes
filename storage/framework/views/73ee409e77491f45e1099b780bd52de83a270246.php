                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        <?php if(count($property_enquiries) > 0): ?>
                                        	<?php $__currentLoopData = $property_enquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <?php if($row->read == 0): ?>
                                                        <td><b><?php echo e($key + 1); ?></b></td>
                                                        <td><b><?php echo e($row->property_id); ?> </b></td>
                                                        <td><b><?php echo e($row->name); ?> </b></td>
                                                        <td><b><?php echo e($row->email); ?></b> </td>
                                                        <td><b><?php echo e($row->phone); ?> </b></td>
                                                        <td><b><?php echo e($row->address); ?></b></td>
                                                        <td><b><?php echo e($row->message); ?></b></td>
                                                        <td>
                                                            <a href="<?php echo e(url('')); ?>/admin/properties_index/read/<?php echo e($row->id); ?>" class="btn btn-success  waves-effect" type="submit"><i class="far fa-eye"></i></a>
        ...
        swal({
          ...
          function(confirmButtonText){
                if (confirmButtonText) {
                    window.location ='<?php echo e(url('')); ?>/admin/properties_index/delete/'+id;
                }   
        });
    }
</script>
