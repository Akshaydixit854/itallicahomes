    ...
    <div class="main-sec">
        <div class="content-sec">
            <div class="logo-sec text-center">
                <a href="http://www.italicahomes.com" target="_blank" class="logo-img"><img src="<?php echo e(url('')); ?>/ui/images/pdf_template/logo.png" style="margin-left:45%"></a>
            </div>
            <div class="det-property">
               ...
               <!--  <div class="map-sec mt-20">
                    ...
                    <div class="" id="map" style="width: 100%; height: 300px;"><img src="<?php echo e(url('/')); ?><?php echo e(Storage::url('public/ui/images/pdf_template/somename.png')); ?>" alt="" style="width: 100%;">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="">
                            <div class="gallery-box big-img">
                                <img  style ="height: 370px;width: 100%;" src=<?php echo e(asset("/images/cover-images/".$gallery_image->image)); ?>>
                            </div>
                        </div>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                       <?php else: ?>
            ...
            <footer class="text-center">
                ...
                <div class="number-block">
                    <ul class="num-list list-unstyled inline m-0">
                        <li>
                            <p class="num-txt"><?php echo app('translator')->getFromJson('app.phone_number'); ?>: <a href="javascript:void(0);" class="num-link">&nbsp; +49 8538 2659988</a></p>
                        </li>
                        <li>
