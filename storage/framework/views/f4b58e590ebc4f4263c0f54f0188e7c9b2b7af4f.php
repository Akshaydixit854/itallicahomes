...
?>
    ...
    <div class="wrapper">
        <div class="about-us-text-wrapper">
            ...
            <input type="hidden" name="post_img" id="post_img" value=<?php echo e(asset("images/post-cover-images/". $OwnerService->cover_image)); ?>><?php echo app('translator')->getFromJson('app.owner_services'); ?>
