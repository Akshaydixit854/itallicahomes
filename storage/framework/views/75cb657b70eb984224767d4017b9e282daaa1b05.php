                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>Testimonials</h2>
                            <a href="<?php echo e(route('add-testimonial.create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                    ...
                                    <tbody>
                                        <?php if(count($testimonials) > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-prev-img"><a target="_blank" href="<?php echo e(url('')); ?>/images/testimonial-covers/<?php echo e($row->cover_image); ?>"> <img  src="<?php echo e(url('')); ?>/images/testimonial-covers/<?php echo e($row->cover_image); ?>" /></td></td>
                                                <td class="table-tit"><?php echo e($row->name); ?> </td>
                                                <td class="table-des"><?php echo e($row->description); ?> </td>
                                            	<td>
                                            		<a href="<?php echo e(route('add-testimonial.edit',$row->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                        <form id="delete_form" class="display-inline delete_form_<?php echo e($row->id); ?>" method="POST" action="<?php echo e(route('add-testimonial.destroy',$row->id)); ?>" >
