                        ...
                        <div class="col-md-12">
                            <div class="destinations-list">
                                ...
                                <div class="destinations-list-text">
                                    ...
                                    <a href="<?php echo e(url(''.__('route.destination').'')); ?>/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getdestinationTitle(trans('destination.destination_title_'.$destinations[0]->id)))); ?>" class="desti-view"><?php echo app('translator')->getFromJson('app.read_more'); ?> </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="destinations-list">
                                    ...
                                    <div class="destinations-view-btn">
                                        <a href="<?php echo e(url(''.__('route.destination').'')); ?>/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getdestinationTitle(trans('destination.destination_title_'.$destination->id)))); ?>" class="desti-view"><?php echo app('translator')->getFromJson('app.read_more'); ?> </a>
                                    </div>
                                </div>
                            </div>
                                <?php endif; ?>
