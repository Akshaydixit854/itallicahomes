<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('app.add-new-amenities'); ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>New Amenity</h2>
                            <a href="<?php echo e(route('add-amenities.create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo app('translator')->getFromJson('app.amenities-name'); ?></th>
                                            <th><?php echo app('translator')->getFromJson('app.amenities-display-name'); ?></th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                    ...
                                    <tbody>
                                        <?php if(count($amenitiess) > 0): ?>
                                        	<?php $__currentLoopData = $amenitiess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                            	<td><?php echo e($row->id); ?></td>
                                                <td><?php echo e($row->amenities_name); ?> </td>
                                                <td><?php echo e($row->amenities_display_name); ?> </td>
                                            	<td>
                                            	    <a href="<?php echo e(route('add-amenities.edit',$row->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                    <form class="display-inline delete_form_<?php echo e($row->id); ?>" id="delete_form" method="POST" action="<?php echo e(route('add-amenities.destroy',$row->id)); ?>">
    					                 <?php echo e(csrf_field()); ?>

    					                 <input name="_method" type="hidden" value="DELETE">
                                        <button class="btn btn-danger waves-effect" onclick="delete_record('<?php echo e($row->id); ?>')"
