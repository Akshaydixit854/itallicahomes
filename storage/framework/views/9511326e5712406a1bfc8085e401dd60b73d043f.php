    ...
    <div class="wrapper">
        <div class="about-us-text-wrapper properties-text-wrapper remove-shadow-section">
            <div class="main-container-wrapper">
                <span class="main-heading"><?php echo app('translator')->getFromJson('app.your_fav_properties'); ?><p>There are <abbr class="property_count"><?php echo e(count($properties)); ?></abbr>propertie(s)</p></span>
            </div>
        </div>
    </div>
                        ...
                        <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-3 properties-list-block">
                                <div class="properties-list-wrapper properties-inner-list">
                                    ...
                                    <?php else: ?> <?php echo e(url(''.$lang1.'')); ?>/properties/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id)))); ?><?php endif; ?>" class="properties-link">
                                            <img id="prop_images_<?php echo e($property->id); ?>" class="prop_images" data-main-id="<?php echo e($property->id); ?>"  src=<?php echo e(asset("/images/cover-images/".$property->cover_image_name)); ?>></a></span>
                                    ...
                                    <div class="properties-decription">
                                        ...
                                        <a href="<?php echo e(url('')); ?>/properties/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id)))); ?>" class="properties-link"><?php echo app('translator')->getFromJson('app.read_more'); ?></a></div>
                                    </div>
