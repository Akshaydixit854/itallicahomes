                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            ...
                            <a href="<?php echo e(route('add-agency.create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                    ...
                                    <tbody>
                                        <?php if(count($agencies) > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('add-agency.edit',$row->id)); ?>" class="btn btn-warning waves-effect"> <i class="far fa-edit"></i></a>
                                                </td>
                                                <td>
                                                    <form class="display-inline delete_form_<?php echo e($row->id); ?>" id="delete_form" method="POST" action="<?php echo e(route('add-agency.destroy',$row->id)); ?>">
