<?php $__env->startSection('custom-css'); ?>
    <title><?php echo e(__('app.terms_conditions')); ?></title>
<?php
    if( $Terms ){
    ...
    <div class="wrapper">
        <div class="about-us-text-wrapper remove-box-shadow">
            <div class="main-container-wrapper">
                <span class="main-heading"><?php echo app('translator')->getFromJson('app.terms_conditions'); ?><p></p></span>
                <div class="wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="about-us-content">
                                <?php if($Terms): ?>
                                    <?php if(Config::get('app.locale') == 'en'): ?>
                                        <?php echo $Terms->terms_and_conditions; ?>

                                    <?php elseif(Config::get('app.locale') == 'it'): ?>
                                        <?php echo $Terms->italian; ?>

                                    <?php elseif(Config::get('app.locale') == 'de'): ?>
                                        <?php echo $Terms->german; ?>
