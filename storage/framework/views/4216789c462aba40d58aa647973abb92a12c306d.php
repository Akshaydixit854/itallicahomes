            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                           <form id="form_validation" method="POST" action="<?php echo e(route('roles.store')); ?>">
                            <?php echo e(csrf_field()); ?>
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <?php if($errors->has('name')): ?>
                                        <label id="name-error" class="error" for="email"><?php echo e($errors->first('name')); ?></label>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group form-float">
                                    ...
                                    <select class="form-control show-tick" name="permission[]" multiple required>
                                        <optgroup label="Permission" data-max-options="2">
                                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option><?php echo e($permission); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </optgroup>
                                    </select>
                                     <?php if($errors->has('permission')): ?>
                                        <label id="name-error" class="error" for="email"><?php echo e($errors->first('permission')); ?></label>
                                    <?php endif; ?>
                                </div>
