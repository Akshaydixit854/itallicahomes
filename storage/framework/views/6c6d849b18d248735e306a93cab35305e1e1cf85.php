            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                           <form id="form_validation" method="POST" action="<?php echo e(route('roles.update',$role->id)); ?>">
                            <?php echo e(csrf_field()); ?>
                                ...
                                <div class="form-group form-float">
                                 ...
                                 <div class="form-group form-float">
                                    ...
                                    <select class="form-control show-tick selectpicker" id="your-select" name="permission[]" multiple required>
