            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Users Detail</h2>
                            <a href="<?php echo e(route('users.create')); ?>" class="btn btn-success m-t-15 waves-effect">Add New</a>
                        </div>
                        <div class="body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if(auth()->check() && auth()->user()->hasRole('admin')): ?>
                                                <?php $__currentLoopData = $row->roles()->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php $__currentLoopData = $admin_roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad_role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(!strcmp($role,$ad_role)): ?>
                                                   <a href="<?php echo e(route('users.edit',$row->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?> 
                                        	...
                                        	<td>
                                            <input type="hidden" value="<?php echo e($row->id); ?>"  id="row_no">
                                            <?php if(auth()->check() && auth()->user()->hasRole('admin')): ?>
                                            
                                                <?php $__currentLoopData = $row->roles()->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $__currentLoopData = $admin_roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad_role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(!strcmp($role,$ad_role)): ?>  
                                                            <form id="delete_form" class="delete_form_<?php echo e($row->id); ?>" method="POST" action="<?php echo e(route('users.destroy',$row->id)); ?>">
                                                            <?php echo e(csrf_field()); ?>

                                                            <input name="_method" type="hidden" value="DELETE">
                                                            <button class="btn btn-danger waves-effect" 
                                                            onclick="delete_record('<?php echo e($row->id); ?>')" type="button" id='btn_del'><i class="far fa-trash-alt"></i></button>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
