                     ...
                     <input type="hidden" name="post_id" id="post_id" value="<?php echo e($post->id); ?>">
                       <div class="blog-main-wrapper">
                          <div class="blog-images">
                             <a href="<?php echo e(url('')); ?>/blog/<?php echo e(preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getBlogTitle(trans('blog.blog_title_'.$post['id'])))); ?>"><img src=<?php echo e(asset("images/post-cover-images/". $post['cover_image'])); ?> alt="<?php echo e($post['title']); ?>"></a>
                          </div>
