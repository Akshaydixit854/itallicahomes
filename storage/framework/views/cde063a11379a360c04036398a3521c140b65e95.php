                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>Home Meta Tags</h2>
                            <a href="<?php echo e(route('add-meta-tags.create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Meta Title Iitalian</th>
                                            <th>Meta Title German</th>
                                            <th>Meta Desc_italian</th>
                                            <th>Meta Title German</th>
                                            <th>Meta Description German</th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                    ...
                                    <tbody>
                                        <?php if(count($metatags) > 0): ?>
                                        	<?php $__currentLoopData = $metatags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                            	<td><?php echo e($key + 1); ?></td>
                                                <td><?php echo e($row->meta_title); ?> </td>
                                                <td><?php echo e($row->page); ?> </td>
                                                <td><?php echo e(substr($row->meta_description,0,200)); ?> </td>
                                                <td><?php echo e($row->meta_title_italian); ?> </td>
                                                <td><?php echo e(substr($row->meta_desc_italian,0,200)); ?> </td>
                                                <td><?php echo e($row->meta_title_german); ?> </td>
                                                <td><?php echo e(substr($row->meta_desc_german,0,200)); ?> </td>
                                            	<td>
                                            	    <a href="<?php echo e(route('add-meta-tags.edit',$row->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>                                                    
                                                </td>
                                                <td>
                                            	    <form class="display-inline delete_form_<?php echo e($row->id); ?>" id="delete_form" method="POST" action="<?php echo e(route('add-meta-tags.destroy',$row->id)); ?>">
