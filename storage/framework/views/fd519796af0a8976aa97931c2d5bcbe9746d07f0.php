            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                           <form id="form_validation" method="post" action="<?php echo e(url('')); ?>/admin/buyer_update/<?php echo e($BuyerService->id); ?>" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group ">
                                            <textarea id="ckeditor1" name="content" required ><?php echo e($BuyerService->content); ?></textarea>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea id="ckeditor2"  name="content_italian" required ><?php if(\Lang::has('buyerServiceDesc.buyerService_description_'.$BuyerService->id)): ?> <?php echo e($language_con_desc->text->it); ?> <?php endif; ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea id="ckeditor3" name="content_german" required ><?php if(\Lang::has('buyerServiceDesc.buyerService_description_'.$BuyerService->id)): ?> <?php echo e($language_con_desc->text->de); ?> <?php endif; ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <img src=<?php echo e(asset("images/buyerService-cover-images/" . $BuyerService->cover_image)); ?> width="200px" height="200px"/>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <select class="form-control" name="is_available" required>
                                                    <option value="1" <?php if($BuyerService->is_available == 1): ?><?php echo e('selected'); ?> <?php endif; ?>>Online</option>
                                                    <option value="0" <?php if($BuyerService->is_available == 0): ?><?php echo e('selected'); ?> <?php endif; ?>>Offline</option>
                                                </select>
                                            </div>
