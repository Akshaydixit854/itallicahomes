    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form id="form_validation" method="POST" action="<?php echo e(route('add-meta-tags.update', $meta_tags->id)); ?>"
                    >
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="form-group ">
                            <div class="form-line">
                                <input type="text" class="form-control" name="meta_title" id="meta_title" placeholder="Enter Meta Title" value="<?php echo e($meta_tags->meta_title); ?>">
                            </div>
                        ...
                        <div class="form-group ">
                            <div class="form-line">
                                <textarea rows="2" class="form-control" name="meta_description" id="meta_description" placeholder="Enter Meta Description" ><?php echo e($meta_tags->meta_description); ?></textarea>
                            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group ">
                            <div class="form-line">
                                <input type="text" class="form-control" name="meta_title_german" id="meta_title_german" placeholder="Enter Meta Title German" value="<?php if(isset($meta_tags)): ?> <?php echo e($meta_tags->meta_title_german); ?> <?php endif; ?>">
                            </div>
                        ...
                        <div class="form-group ">
                            <div class="form-line">
                                <textarea rows="2" class="form-control" name="meta_description_german" id="meta_description_german" placeholder="Enter Meta Description German"><?php if(isset($meta_tags)): ?> <?php echo e($meta_tags->meta_desc_german); ?> <?php endif; ?></textarea>
                            </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group ">
                            <div class="form-line">
                                <input type="text" class="form-control" name="meta_title_italian" id="meta_title_italian" placeholder="Enter Meta Title Italian" value="<?php if(isset($meta_tags)): ?> <?php echo e($meta_tags->meta_title_italian); ?> <?php endif; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <textarea rows="2" class="form-control" name="meta_description_italian" id="meta_description_italian" placeholder="Enter Meta Description Italian"><?php if(isset($meta_tags)): ?> <?php echo e($meta_tags->meta_desc_italian); ?> <?php endif; ?></textarea>
                            </div> 
                        ...
                        <label class="form-label">Page Title</label>
                         <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" name="page_title" id="page_title"placeholder="Enter Page Title" value="<?php if(isset($meta_tags->page)): ?> <?php echo e($meta_tags->page); ?> <?php endif; ?>">
                            </div>
                            <?php if($errors->has('page_title')): ?>
                            <label id="name-error" class="error" for="page_title"><?php echo e($errors->first('page_title')); ?> <span class="req_field">*</span></label>
                            <?php endif; ?>
                        </div>
                         <label class="form-label">Meta Keyword</label>
                        <div class="form-group">
                            <div class="form-line">
                                <textarea rows="2" class="form-control" name="meta_keyword" id="meta_keyword" placeholder="Enter Meta Keyword" ><?php if(isset($meta_tags->meta_keyword)): ?> <?php echo e($meta_tags->meta_keyword); ?> <?php endif; ?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <textarea rows="2" class="form-control" name="meta_keyword_italian" id="meta_keyword_italian" placeholder="Enter Meta Keyword German"><?php if(isset($meta_tags->meta_keyword_italian)): ?> <?php echo e($meta_tags->meta_keyword_italian); ?> <?php endif; ?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <textarea rows="2" class="form-control" name="meta_keyword_german" id="meta_keyword_german" placeholder="Enter Meta Keyword Italian"><?php if(isset($meta_tags->meta_keyword_german)): ?> <?php echo e($meta_tags->meta_keyword_german); ?> <?php endif; ?></textarea>
                            </div>
