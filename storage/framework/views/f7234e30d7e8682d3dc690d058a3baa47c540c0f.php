                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST"
                              action="<?php echo e(route('add-property-types.update',$property_type->id)); ?>"
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="type_name"
                                                   ...
                                                   value="<?php echo e($property_type->type_name); ?>">
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="name_italian" value="<?php echo e($property_type->name_italian); ?>"  placeholder="Title  In Italian">
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="name_german" value="<?php echo e($property_type->name_german); ?>"  placeholder="Enter Title  In German">
                                        </div>
                                        <?php if($errors->has('name_italian')): ?>
                                            <label id="name-error" class="error" for="name_italian"><?php echo e($errors->first('name_italian')); ?></label>
                                        <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control" name="description" required
                                                   ...
                                                   ><?php echo e($property_type->description); ?></textarea>
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control" name="content_italian" placeholder="Description  In Italian"><?php echo e($property_type->content_italian); ?></textarea>
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        <div class="form-line">
                                            <textarea rows="2" class="form-control" name="content_german" placeholder="Description In German"><?php echo e($property_type->content_german); ?></textarea>
                                        </div>
                                        <?php if($errors->has('name_italian')): ?>
                                    ...
                                    <div class="form-group ">
                                        <?php $__currentLoopData = $gallery_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <a href="<?php echo e(url('admin/properties/destroy_image')); ?><?php echo e('/'.$gallery_image->id); ?>">Delete</a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <label class="form-label">UI Color</label>
                                    <div class="input-group colorpicker">
                                        <div class="form-line">
                                            <input type="text" name="ui_color" class="form-control" value="<?php echo e($property_type->ui_color); ?>">
                                        </div>
                                    ...
                                    <label class="form-label">UI Icon</label>
                                        <input class="icp demo admin-pro-icon" name="ui_icon" value="<?php echo e($property_type->ui_icon); ?>" type="text">
                                </div>
                            </div>
