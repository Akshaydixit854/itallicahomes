<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->getFromJson('app.add-new-condition'); ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            ...
                            <a href="<?php echo e(route('add-condition.create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        <?php if(count($conditions) > 0): ?>
                                        	<?php $__currentLoopData = $conditions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                            	<td><?php echo e($key + 1); ?></td>
                                                <td><?php echo e($row->condition_name); ?> </td>
                                                <td><?php echo e($row->condition_display_name); ?> </td>
                                            	<td>
                                            	    <a href="<?php echo e(route('add-condition.edit',$row->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                            	    <form class="display-inline delete_form_<?php echo e($row->id); ?>" id="delete_form" method="POST" action="<?php echo e(route('add-condition.destroy',$row->id)); ?>">
