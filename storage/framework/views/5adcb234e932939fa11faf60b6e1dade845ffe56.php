                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>Buyer Services</h2>
                            <a href="<?php echo e(url('')); ?>/admin/buyer_create" class="btn btn-info m-t-15 waves-effect">Add New</a>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        <?php if(count($BuyerService) > 0): ?>
                                        	<?php $__currentLoopData = $BuyerService; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php //dd($row->id);?>
                                            <tr>
                                            	<td><?php echo e($key+1); ?></td>
                                                <td class="table-prev-img"><img src=<?php echo e(asset("images/buyerService-cover-images/" . $row->cover_image)); ?> width="200px" height="100px"></td>
                                            	...
                                            	<td>
                                            		<a href="<?php echo e(url('')); ?>/admin/buyer_edit/<?php echo e($row->id); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                       <form id="delete_form" class="display-inline delete_form_<?php echo e($row->id); ?>" method="POST" action="<?php echo e(url('')); ?>/admin/buyer_delete/<?php echo e($row->id); ?>">
