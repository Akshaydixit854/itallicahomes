                                    ...
                                    <?php $__currentLoopData = $contact_faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <?php if($row->is_read == 0): ?>
                                                ...
                                                <td>
                                                   <a href="<?php echo e(url('')); ?>/admin/mark/read/<?php echo e($row->id); ?>" class="btn btn-success waves-effect" type="submit"><i class="far fa-eye"></i></a>
                                                </td>
                                                <td>
                                                   <a href="<?php echo e(url('')); ?>/admin/mark/delete/<?php echo e($row->id); ?>" class="btn btn-danger waves-effect" type="submit"><i class="far fa-trash-alt"></i></a>
                                                </td>
                                            <?php else: ?>
