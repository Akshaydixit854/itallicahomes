                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            ...
                            <a href="<?php echo e(url('/admin/terms/create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        <?php if($Terms): ?>
                                            <tr>
                                            	<td><?php echo e('1'); ?></td>
                                                <td class="table-tit"><?php echo $Terms->terms_and_conditions; ?> </td>
                                            	<td>
                                            	    <a href="<?php echo e(url('/admin/terms/edit',$Terms->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                    <form class="display-inline" id="delete_form" method="POST" action="<?php echo e(url('/admin/terms/delete',$Terms->id)); ?>">
