        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-pink">
                    <h2>FAQs</h2>
                    <a href="<?php echo e(route('add-faq.create')); ?>" class="btn btn-info m-t-15 waves-effect">Add New</a>
                        ...
                        <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td>
                                       <a href="<?php echo e(route('add-faq.edit',$row->id)); ?>" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                   </td>
                                   <td>
                                    <form id="delete_form" class="display-inline delete_form_<?php echo e($row->id); ?>" method="POST" action="<?php echo e(route('add-faq.destroy',$row->id)); ?>">
