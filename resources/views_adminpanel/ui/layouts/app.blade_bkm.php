                ...
                <div class="col-md-12">
                    <div class="top-header-menu">
                        ...
                        <ul class="language-list">
                            ...
                            <li ><a href="{{url('/')}}/en" style="@if(Config::get('app.locale') == 'en') {{'color:green'}} @endif"><img src={{asset("/ui/images/english.png")}}>@lang('app.english')</a></li>
                            <li><a href="{{url('/')}}/it" style="@if(Config::get('app.locale') == 'it') {{'color:green'}} @endif"><img src={{asset("/ui/images/italian.png")}}>@lang('app.italian')</a></li>
                            <li><a href="{{url('/')}}/de" style="@if(Config::get('app.locale') == 'de') {{'color:green'}} @endif"><img src={{asset("/ui/images/german.png")}}>@lang('app.german')</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-10 responsive-menu">
                        ...
                        <ul class="menu-list">
                            ...
                            <li class="{{ $active == 'blog' ? 'active' : '' }}">
                                <a href={{url('blog')}}><i>&#xf02d;</i>@lang('app.blog')</a>
                            </li>
                    ...
                    <div class="col-md-2 col-sm-6">
                        <ul class="footer-menu-list">
                           ...
                           <!--  <li>
                            ...
                            <li>
                                <span><a href=>@lang('app.blog')</a></span>
                            </li>
                            <li>
