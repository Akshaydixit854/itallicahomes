...
<div style="line-height:20px;font-size:1px">&#160;</div>  <img class="center fixedwidth" align="center" border="0" src="{{asset('ui/images/logo.png')}}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 240px" width="240">
...
<!--[if mso]></td></tr></table><![endif]-->
                    ...
                    <div class="">
                      <p>Property ID - {{isset($data['property_id']) ? $data['property_id'] : ''}}</p>
                      <p>Property Name - {{isset($data['property_name']) ? $data['property_name'] : ''}}</p>
                      <p>Enquired By - {{isset($data['name']) ? $data['name'] : ''}}</p>
                      <p>Enquiry Address - {{isset($data['address']) ? $data['address'] : ''}}</p>
                      <p>Enquiry Phone - {{isset($data['phone']) ? $data['phone'] : ''}}</p>
                      <p>Enquiry Message - {{isset($data['message']) ? $data['message'] : ''}}</p>
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
    ...
    <div style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;"> 
        <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center; text-transform: uppercase;"></p></div>   
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
</div>
