                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="testimonial-slider" class="owl-carousel custom-slider-arrow">
                                    ...
                                    @else {{url(''.$lang1.'')}}/properties/{{preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id))) }}@endif" class=""><img src={{asset("/images/cover-images/".$related_property->cover_image_name)}}></a></span>
