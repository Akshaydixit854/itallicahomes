					...
					<tbody>
						<tr>
							<td style="padding: 0 20px;">
								<p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; font-weight: 600; padding-bottom: 5px; padding-top: 5px; margin:0;"><a href="#" style="color: #333; text-decoration: underline;">@if(\Lang::has('property.property_title_'.$data['property_id']))
                               {{trans('property.property_title_'.$data['property_id'])}}
                           @else
                               {{$data['property_name']}}
                           @endif,  @if(\Lang::has('region.region_title_'.$data['region_id']))
									...
									<tbody>
										<tr>
											<td style="padding-right:10px; padding-top: 5px;">
												<img style="width: 100%;" src="{{asset("/images/cover-images/".$data['cover_image_name'])}}" alt="#" />
											</td>
										</tr>
									</tbody>
								</table>
									...
									<tbody>
										<tr>
											<td style="padding-left: 10px; padding-top: 5px;">
												...
												<p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;"><b> @if(\Lang::has('property_offer.property_offer_title_'.$data['offer_id']))
                              {{trans('property_offer.property_offer_title_'.$data['offer_id'])}}
                          @else
                              {{(new \App\Services\PropertyService)->getOffer($data['offer_id']) }}
                          @endif
                          /</b> {{number_format($data['price'] , 0, ',', '.')}} €
                    </p>
												<p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">ca. {{ $data['plot_size']}} m<sup>2</sup> @lang('app.area') </p>
												<p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">ca.{{$data['living_area']}} m<sup>2</sup></p>
												...
												<p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">Kauferprovision: <span>+ {{ $data['vat'] }}% @lang('app.taxmode')</span></p>
											</td>
										</tr>
									</tbody>
								</table>
									...
									<tbody>
										<tr>
											<td style="padding: 7px 10px;background-color: #F0F0F0;">
												...
												<p class="para-2" style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; float: left; padding-bottom: 5px; width: 65%; padding-top: 5px; margin:0;">{{isset($data['name']) ? $data['name'] : 'N/A'}}</p>
											</td>
										</tr>
									</tbody>
								</table>
									...
									<tbody>
										<tr>
											<td style="padding: 7px 10px;background-color: #F0F0F0;">
												...
												<p class="para-2" style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; float: left; padding-bottom: 5px; width: 65%; padding-top: 5px; margin:0;">{{isset($data['address']) ? $data['address'] : ''}}</p>
											</td>
										</tr>
									</tbody>
								</table>
									...
									<tbody>
										<tr>
											<td style="padding: 7px 10px;background-color: #F0F0F0;">
												...
												<p class="para-2" style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; float: left; padding-bottom: 5px; width: 65%; padding-top: 5px; margin:0;">{{isset($data['message']) ? $data['message'] : ''}}</p>
											</td>
										</tr>
									</tbody>
								</table>
