    ...
    <div class="main-sec">
        <div class="content-sec">
            <div class="logo-sec text-center">
                <a href="http://www.italicahomes.com" target="_blank" class="logo-img"><img src="{{url('')}}/ui/images/pdf_template/logo.png"
            ...
            <footer class="text-center">
                ...
                <div class="number-block">
                    <ul class="num-list list-unstyled inline m-0">
                        <li>
                            <p class="num-txt">Email: <a href="mailto:info@italica.de" class="num-link">&nbsp; info@italicahomes.com</a></p>
                        </li>
                    </ul>
                </div>                
