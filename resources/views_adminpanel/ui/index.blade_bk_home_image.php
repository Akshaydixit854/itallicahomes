            ...
            <div class="main-container-wrapper">
                ...
                <div class="search-bar-form">
                  <!--   @if($lang1 == 'en')
                     ...
                     @else 
                         <form action="{{url(''.$lang1.'')}}/{{$srch}}" method="POST" class="home-search-form">

                     @endif-->

                         <form action="{{url('')}}/{{$srch}}" method="POST" class="home-search-form">
                                ...
                                <div class="col-md-4">
                                    <div class="properties-list-wrapper home-pro equal-height">
                                        <div class="properties-pic-section">
                                            <span><a href="{{url('')}}/properties/{{preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id))) }}
                                   " ><img id="prop_images_{{$property->id}}" class="prop_images" id="prop_images_{{$property->id}}" data-main-id="{{$property->id}}" src={{asset("/images/cover-images/".$property->cover_image_name)}}></a></span>
                                        ...
                                        <div class="properties-name">
                                            @if(\Lang::has('property.property_title_'.$property->id))
                                                <span><em>{{(new \App\Services\PropertyService)->truncate(trans('property.property_title_'.$property->id)) }}</em><i><a class="heart-fav" id="heart-fav_{{$property->id}}" data-main-id="{{$property->id}}" href="{{url('')}}/favourite/{{$property->id}}">{!! (new \App\Services\PropertyService)->checkFav($property->id) !!}</a></i></span>
                                            @else
                                                <span><em>{{(new \App\Services\PropertyService)->truncate($property->name)}}</em><i><a class="heart-fav" id="heart-fav_{{$property->id}}" data-main-id="{{$property->id}}" href="{{url('')}}/favourite/{{$property->id}}">{!! (new \App\Services\PropertyService)->checkFav($property->id) !!}</a></i></span>
                                            @endif
                        ...
                        <div class="col-md-7">
                            <div class="about-us-content">
                                ...
                                <p>@lang('app.about_us_para2')</p>
                                 @if($lang1 == 'en')
                                   <a href="{{url(''.$abt.'')}}">@lang('app.read_more')</a>
                                 @else
                                   <a href="{{url(''.$lang1.'')}}/{{$abt}}">@lang('app.read_more')</a>
                                 @endif
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="about-right-side-img">
                                <img  id='about_us_img' src={{asset("ui/images/about-pic.png")}} alt="about-pic" class="responsive about-us"/>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('custom-js')
    ...
    {{ Html::script('ui/js/scroll_top.js') }}
     ...
     /*           
           $('.prop_images').mouseenter(function() {
                    console.log('fdfdf');
                ...
                $('.prop_images').mouseleave(function() {   
                    var prop_id =$(this).attr('data-main-id');
                    $('#prop_images_'+prop_id).css("cursor","pointer");
       ...
       /*     $('.prop_images').mouseenter(function() {
                ...
                $('.about-us').on('mouseleave',function() {   
                    $('#about_us_img').css("cursor","pointer");
                    $('#about_us_img').animate({width: "100%", height: "auto"}, 'slow');
                });
