                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="destinations-list">
                                ...
                                @if($lang1 == 'en')
                                        <a href="{{url(''.$single_dest.'')}}/{{preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getdestinationTitle(trans('destination.destination_title_'.$destinations[0]->id))) }}" class="desti-view">@lang('app.read_more') </a>
                                    @else
                                         <a href="{{url(''.$lang1.'')}}/{{$single_dest}}/{{preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getdestinationTitle(trans('destination.destination_title_'.$destinations[0]->id))) }}" class="desti-view">@lang('app.read_more')</a>
                                    @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="destinations-list">
                                    ...
                                    @if($lang1 == 'en')
                                        <a href="{{url(''.$single_dest.'')}}/{{preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getdestinationTitle(trans('destination.destination_title_'.$destination->id))) }}" class="desti-view">@lang('app.read_more') </a>
                                    @else
                                         <a href="{{url(''.$lang1.'')}}/{{$single_dest}}/{{preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getdestinationTitle(trans('destination.destination_title_'.$destination->id))) }}" class="desti-view">@lang('app.read_more')</a>
                                    @endif
