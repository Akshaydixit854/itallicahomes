                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li {{Route::is('inbox')||Route::is('inbox')||Route::is('inbox')? 'class=active':''}}>
                            <a href="/admin/inbox"><i class="fas fa-chevron-right"></i>View All Messages</a>
                        </li>
                        <li {{Route::is('inbox')||Route::is('inbox')||Route::is('inbox')? 'class=active':''}}>
                            <a href="/admin/inbox/unread"><i class="fas fa-chevron-right"></i>Unread</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li {{Route::is('terms-conditions.index')||Route::is('terms-conditions.create')||Route::is('terms-conditions.edit')? 'class=active':''}}>
                            <a href="/admin/terms/index"><i class="fas fa-chevron-right"></i>Terms & Conditions</a>
                        </li>
                        <li {{Route::is('legal-notice')||Route::is('legal-notice.create')||Route::is('legal-notice.edit')? 'class=active':''}}>
                            <a href="/admin/legal_notice/index"><i class="fas fa-chevron-right"></i>Legal Notice</a>
                        </li>
                        <li {{Route::is('privacy-policy')||Route::is('privacy-policy.create')||Route::is('privacy-policy.edit')? 'class=active':''}}>
                            <a href="/admin/privacy_policy/index"><i class="fas fa-chevron-right"></i>Privacy Policy</a>
                        </li>
                    </ul>
