...
<form id="sign_in" role="form" method="POST" action="{{ url('customer/login') }}">
    {{ csrf_field() }}
    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <button class="btn btn-block bg-pink waves-effect sign-btn" type="submit">SIGN IN</button>
        </div>
    </div>
    <div class="row m-t-15 m-b--20">
         <div class="col-xs-6">
            <a href="{{url('customer/register')}}">New? Register Now!</a>
        </div>
