                                ...
                                <table class="display table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        @if (count($testimonials) > 0)
                                            ...
                                            <tr>
                                            	<td>{{ $row->id }}</td>
                                                <td class="table-prev-img"><a target="_blank" href="/images/testimonial-covers/{{$row->cover_image}}"> <img  src="/images/testimonial-covers/{{$row->cover_image}}" /></td></td>
                                            	...
                                            	<td>
                                            		<a href="{{route('add-testimonial.edit',$row->id)}}" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                        <form id="delete_form" class="display-inline" method="POST" action="{{ route('add-testimonial.destroy',$row->id) }}">
    					                            	{{ csrf_field() }}
