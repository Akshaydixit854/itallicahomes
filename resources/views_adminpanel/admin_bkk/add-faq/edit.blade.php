                            ...
                            <form id="form_validation" method="POST" action="{{ route('add-faq.update',$faq->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                               <textarea rows="2" class="form-control" name="answer" value="{{$faq->answer}}" required placeholder="Enter Answer"></textarea>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea rows="2" class="form-control" name="answer_italian" value="@if(\Lang::has('faq.faq_answer_'.$faq->id)) {{$language_ans->text->it}} @endif"  placeholder="Answer In Italian"></textarea>
                                            </div>
                                            @if ($errors->has('name_italian'))
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea rows="2" class="form-control" name="answer_german" value="@if(\Lang::has('faq.faq_answer_'.$faq->id)) {{$language_ans->text->de}} @endif"  placeholder="Answer  In German"></textarea
>
                                            </div>
                                            @if ($errors->has('name_italian'))
