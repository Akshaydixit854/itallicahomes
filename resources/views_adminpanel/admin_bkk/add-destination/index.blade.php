                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        @if (count($destinations) > 0)
                                            ...
                                            <tr>
                                            	<td>{{ $key + 1 }}</td>
                                                <td><a target="_blank" href="/images/destination-covers/{{$row->cover_image}}" class="table-prev-img"> <img  src="/images/destination-covers/{{$row->cover_image}}" width="200px" height="100px" /></td></td>
                                            	...
                                            	<td>
                                                    ...
                                                    <form class="display-inline" id="delete_form" method="POST" action="{{ route('add-destination.destroy',$row->id) }}">
    					                  {{ csrf_field() }}
