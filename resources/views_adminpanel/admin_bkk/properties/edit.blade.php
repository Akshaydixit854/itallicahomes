                                   ...
                                   <div class="row">
                                        <div class="col-sm-12">
                                         ...
                                         <div class="col-sm-12">
                                              ...
                                              <div class="form-group ">
                                                   <div class="form-line">
                                                       <img src={{asset("images/cover-images/" . $property->cover_image_name)}} width="200px" height="200px"/>
...
@section('extra-script')
    ...
    <script>
        ...
        $("#button").click(function (e) {
            ...
            || isNaN(plot_size) || isNaN(living_area) || isNaN(latitude) || isNaN(longitude) || isNaN(price) || isNaN(vat))
            {
                if(name == ''){
                    //console.log('1');
        ...
        $("#preview-button").click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    if(cover_image > 0){
                        $.ajax({
                            url: '/admin/property_preview_edit/'+temp_id,
                            processData: false,
                            dataType : "JSON",
                            contentType: false,
                            data: formImage,
