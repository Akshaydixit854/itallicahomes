                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            ...
                            <a href="{{route('add-agency.create')}}" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                    ...
                                    <tbody>
                                        @if (count($agencies) > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->email }} </td>
                                            	<td>
                                            	    <a href="{{route('add-agency.edit',$row->id)}}" class="btn btn-warning waves-effect"> <i class="far fa-edit"></i></a>
                                            	    <form class="display-inline" id="delete_form" method="POST" action="{{ route('add-agency.destroy',$row->id) }}">
    					                  {{ csrf_field() }}
