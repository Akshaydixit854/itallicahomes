                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            ...
                            <a href="{{route('add-region.create')}}" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                    ...
                                    <tbody>
                                        @if (count($regions) > 0)
                                            ...
                                            <tr>
                                            	...
                                            	<td>
                                            	    <a href="{{route('add-region.edit',$row->id)}}" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                    <form class="display-inline delete_form_{{$row->id}}" id="delete_form" method="POST" action="{{ route('add-region.destroy',$row->id) }}">
    					                  {{ csrf_field() }}
