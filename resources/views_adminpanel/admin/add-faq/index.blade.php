                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>FAQs</h2>
                            <a href="{{route('add-faq.create')}}" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                    ...
                                    <tbody>
                                        @if (count($faqs) > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->priority }} </td>
                                            	<td>
                                            	    <a href="{{route('add-faq.edit',$row->id)}}" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                    <form id="delete_form" class="display-inline delete_form_{{ $row->id}}" method="POST" action="{{route('add-faq.destroy',$row->id) }}">
    					                  {{ csrf_field() }}
