                               ...
                               {{ csrf_field() }}
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea rows="2" class="form-control" name="short_description" placeholder="Short Description">{{$post->short_description}}</textarea>
                                            </div>
                                            @if ($errors->has('name_italian'))
                                                <label id="name-error" class="error" for="name_italian">{{ $errors->first('name_italian') }}</label>
                                            @endif
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea rows="2" class="form-control" name="italian_short_description" placeholder="Enter Short Description In Italian">{{(\Lang::has('blog.blog_short_description_'.$post->id)) ? $language_desc->text->it : '' }}</textarea>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea rows="2" class="form-control" name="german_short_description" placeholder="Enter Short Description In German">{{(\Lang::has('blog.blog_short_description_'.$post->id)) ? $language_desc->text->de : ''}}</textarea>
                                            </div>
