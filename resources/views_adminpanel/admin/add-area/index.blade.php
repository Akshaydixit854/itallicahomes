                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>New Location</h2>
                            <a href="{{route('add-area.create')}}" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                    ...
                                    <tbody>
                                        @if (count($areas) > 0)
                                            ...
                                            <tr>
                                            	...
                                            	<td>
                                            	    <a href="{{route('add-area.edit',$row->id)}}" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                    <form class="display-inline delete_form_{{$row->id}}" id="delete_form" method="POST" action="{{ route('add-area.destroy',$row->id) }}">
    					                   {{ csrf_field() }}
