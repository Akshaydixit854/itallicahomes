      ...
      <td>
            ...
            <tr>
              <td style="padding: 0 20px;">
                <p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; font-weight: 600; padding-bottom: 5px; padding-top: 5px; margin:0;"><a href="#" style="color: #333; text-decoration: underline;"><p>
                       <span>
                           @if(\Lang::has('region.region_title_'.$data['region_id']))
                       ...
                       <span>
                           @if(\Lang::has('property.property_title_'.$data['id']))
                               {{trans('property.property_title_'.$data['id'])}}
                           @else
                               {{$data['property_name']}}
                           @endif
                       </span>
                  ...
                  <tbody>
                    <tr>
                      <td style="padding-left: 10px; padding-top: 5px;">
                        <p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">@lang('app.region') @if(\Lang::has('region.region_title_'.$data['region_id']))
                                         {{trans('region.region_title_'.$data['region_id'])}}
                                     @else
                                         {{(new \App\Services\PropertyService)->getRegion($data['region_id']) }}
                                     @endif </p>
                        <p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">{{number_format($data['price'] , 0, ',', '.')}}</p>
                        <p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">ca. {{$data['plot_size']}} m<sup>2</sup> {{$data['plot_size']}} </p>
                        <p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">ca. <i>{{$data['living_area']}} m<sup>2</sup> @lang('app.size') </p>
                        <p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">{{$data['beds']}} @lang('app.bedrooms')</p>
                       <!--  <p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 35px; margin:0;">Ref-Nr.: V000288</p> -->
                        <p style="font-family: sans-serif; font-size: 16px; color: #333; text-align: left; padding-bottom: 5px; padding-top: 5px; margin:0;">Kauferprovision: + {{ $data['vat'] }}% @lang('app.taxmode') </p>
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <table width="100%" cellpadding="0" bgcolor="#F0F0F0" cellspacing="0" border="0" align="center">
          <tbody>
            ...
            <!-- <tr>
              <td style="padding:20px; text-align: center;">
                <a href="https://www.facebook.com/italicahomes/"><img style="width: 18px; margin: 0 13px;" src="{{asset('images/contact_enquiry/img1.png')}}" alt="#" /></a>
                ...
                <a href="https://twitter.com/livingartIT"><img style="width: 33px; margin: 0 13px;" src="{{asset('images/contact_enquiry/img4.png')}}" alt="#" /></a>
