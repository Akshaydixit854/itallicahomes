                                        ...
                                        <div class="share-social-media idcontainer" id="share-detail4" style="display:none;">
                                            ...
                                            <div class="share-inner-content">
                                                <ul class="share-social-media-icon">
                                                    ...
                                                    <li><a href="mailto:?subject={{$property->name}}&body=Check out this site {{url('')}}/properties/{{(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$property->id))}}" target="_blank"><i class="far fa-envelope"></i></a></li>
                                            ...
                                            <div class="wrapper">
                                                <div class="properties-list-wrapper">
                                                    <div class="properties-pic-section">
                                                        <span><a href="{{url('')}}/properties/{{preg_replace('/[[:space:]]+/', '+',(new \App\Services\PropertyService)->getPropertytitle(trans('property.property_title_'.$related_property->id))) }}" class=""><img src={{asset("/images/cover-images/".$related_property->cover_image_name)}}></a></span>
    ...
    <script>
        ...
        function initMap() {
            ...
            for (i = 0; i < locations.length; i++) {
              ...
              con+='<i class="properties-price-doller">'+locations[i]['price']+'</i></div> <div class="map-hover-properties-btn"><a href="javascript:void(0);" data-toggle="modal" data-target="#quick-map-modal-'+locations[i]['id']+'" class="quick-btn">@lang('app.quick_view')</a>';
