            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Roles</h2>
                            <a href="{{route('roles.create')}}" class="btn btn-success m-t-15 waves-effect">Add New</a>
                        </div>
                        <div class="body">
                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	...
                                        	<td>
                                        		<a href="{{route('roles.edit',$row->id)}}" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                            </td>
                                            <td>
                                                <form class="display-inline delete_form_{{$row->id}}" id="delete_form" method="POST" action="{{ route('roles.destroy',$row->id) }}">
					                   {{ csrf_field() }}
