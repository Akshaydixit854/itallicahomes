            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                           <form id="form_validation" method="post" action="{{ url('') }}/admin/owner_update/{{$ownerService->id}}" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group ">
                                            <textarea id="ckeditor1" name="content" required >{{$ownerService->content}}</textarea>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea id="ckeditor2"  name="content_italian" required >@if(\Lang::has('ownerServiceDesc.ownerService_description_'.$ownerService->id)) {{$language_con_desc->text->it}} @endif</textarea>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <textarea id="ckeditor3" name="content_german" required >@if(\Lang::has('ownerServiceDesc.ownerService_description_'.$ownerService->id)) {{$language_con_desc->text->de}} @endif</textarea>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <img src={{asset("images/ownerService-cover-images/" . $ownerService->cover_image)}} width="200px" height="200px"/>
                                        ...
                                        <div class="form-group ">
                                            <div class="form-line">
                                                <select class="form-control" name="is_available" required>
                                                    <option value="1" @if($ownerService->is_available == 1){{'selected'}} @endif>Online</option>
                                                    <option value="0" @if($ownerService->is_available == 0){{'selected'}} @endif>Offline</option>
                                                </select>
                                            </div>
