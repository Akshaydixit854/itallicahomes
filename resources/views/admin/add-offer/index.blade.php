                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>Property Offers</h2>
                            <a href="{{route('add-offer.create')}}" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td>
                                               <a href="{{route('add-offer.edit',$row->id)}}" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                           </td>
                                           <td>
                                            <form class="display-inline delete_form_{{$row->id}}" id="delete_form" method="POST" action="{{ route('add-offer.destroy',$row->id) }}">
                                             {{ csrf_field() }}
