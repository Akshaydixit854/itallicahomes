            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                           <form id="form_validation" method="POST" action="{{ route('add-items.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            ...
                                            @if ($errors->has('name'))
                                                <label id="name-error" class="error" for="type_name">{{ $errors->first('type_name') }}</label>
                                            @endif
                                        </div>
                                    </div>
                                </div>
