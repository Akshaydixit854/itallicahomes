                                        	...
                                        	@foreach($contact_enquireis as $key => $row)
                                                <tr>
                                                    @if($row->read == 0)
                                                        ...
                                                        <td>
                                                            <a href="{{url('')}}/admin/general_mark/read/{{$row->id}}" class="btn btn-success  waves-effect" type="submit"><i class="far fa-eye"></i></a>
        ...
        swal({
          ...
          function(confirmButtonText){
                if (confirmButtonText) {
                    window.location ='{{url('')}}/admin/general_mark/delete/'+id;
                }   
        });
    }
</script>
