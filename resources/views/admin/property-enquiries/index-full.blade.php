                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="contact-card">
                            <p><b>PropertyId</b> - {{$PropertyEnquiry->property_id}}</p>
                            <p><b>User Name</b> - {{$PropertyEnquiry->name}}</p>
                            <p><b>Email</b> - {{$PropertyEnquiry->email}}</p>
                            <p><b>Phone</b> - {{$PropertyEnquiry->phone}}</p>
                            <p><b>Address</b> - {{$PropertyEnquiry->address}}</p>
                            <p><b>Message</b> - {{$PropertyEnquiry->message}}</p>
                        </div>
