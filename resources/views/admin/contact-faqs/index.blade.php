                                    ...
                                    @foreach($contact_faqs as $key => $row)
                                        <tr>
                                            @if($row->is_read == 0)
                                                ...
                                                <td>
                                                   <a href="{{url('')}}/admin/mark/read/{{$row->id}}" class="btn btn-success waves-effect" type="submit"><i class="far fa-eye"></i></a>
                                                </td>
                                                <td>
                                                   <a href="{{url('')}}/admin/mark/delete/{{$row->id}}" class="btn btn-danger waves-effect" type="submit"><i class="far fa-trash-alt"></i></a>
                                                </td>
                                            @else
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $row->name }} </td>
