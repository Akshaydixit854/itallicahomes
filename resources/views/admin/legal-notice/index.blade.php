                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>Legal Notice</h2>
                            <a href="{{url('/admin/legal_notice/create')}}" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                ...
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        @if ($LegalNotices)
                                            <tr>
                                            	<td>{{ '1' }}</td>
                                                <td class="table-tit">{!! $LegalNotices->legal_notice !!} </td>
                                            	<td>
                                            	    <a href="{{url('/admin/legal_notice/edit',$LegalNotices->id)}}" class="btn btn-warning waves-effect"><i class="far fa-edit"></i></a>
                                                    <form class="display-inline" id="delete_form" method="POST" action="{{ url('/admin/legal_notice/delete',$LegalNotices->id) }}">
    					                  {{ csrf_field() }}
