...
<div class="container-fluid">
							...
							<div class="col-sm-12">
								...
								<div class="row" >
									<div class=col-sm-2>
										...
										<div class="form-group ">
											<div class="form-line">
												<input type="text" class="form-control" value="0" id="property_beds" maxlength='2' name="beds" required placeholder="Enter No. of Beds">
											</div>
											@if ($errors->has('beds'))
									...
									<div class=col-sm-2>
										...
										<div class="form-group ">
											<div class="form-line">
												<input type="text" class="form-control" value="0" id="property_baths" name="baths" maxlength='2' required placeholder="Enter No. of Baths">
											</div>
											@if ($errors->has('baths'))
									...
									<div class=col-sm-2>
										...
										<div class="form-group ">
											<div class="form-line">
												<input type="text" class="form-control" value="0" id="property_kitchen" name="kitchens" maxlength='2' placeholder="Enter No. of Beds">
											</div>
											@if ($errors->has('beds'))
											<label id="name-error" class="error" for="beds">{{ $errors->first('beds') }}</label>
											@endif
									...
									<div class=col-sm-2>
										...
										<div class="form-group ">
											<div class="form-line">
												<input type="text" class="form-control" value="0" name="parking" id="property_parking" maxlength='2' placeholder="Parking">
											</div>
									...
									<div class=col-sm-2>
										...
										<div class="form-group ">
											<div class="form-line">
												<input type="text" class="form-control" value="0" name="fireplace" id="property_fire_place" maxlength='2'>
											</div>
											@if ($errors->has('beds'))
											<label id="name-error" class="error" for="beds">{{ $errors->first('beds') }}</label>
											@endif
									...
									<div class=col-sm-2>
										...
										<div class="form-group ">
											<div class="form-line">
												<input type="text" class="form-control" value="0" name="terrace" id="property_terrace" maxlength='2' >
											</div>
    ...
    $('body').on('keypress', '#property_sequence_id, #price, #property_beds, #property_baths, #property_kitchen, #property_parking, #property_fire_place, #property_terrace, #living_area, #plot_size, #latitude,#longitude', function(event) {
				...
				$("#button").click(function (e) {
					...
					var meta_description = $('#meta_description').val().trim();
						...
						if(name == '' || property_id == '' || property_sequence_id == '' || detail_description == '' || property_beds == '' || short_description == ''
							...
							|| isNaN(plot_size) || isNaN(living_area) || isNaN(latitude) || isNaN(longitude) || isNaN(price) || isNaN(vat) || cover_image <= 0 || meta_title == '' || meta_description == '')
						{
							if(name == ''){
										//console.log('1');
...
$("#preview-button").click(function() {
	...
	$.ajax({
		url: '{{url('')}}/admin/property_preview',
		data: {
			'name' : name,
			...
			'price' : price,
									...
									success: function(data){
										if(cover_image > 0){
											$.ajax({
												url: '{{url('')}}/admin/property_preview/'+temp_id,
												processData: false,
												dataType : "JSON",
												contentType: false,
												data: formImage,
												type: "POST",
												success: function(data){
													var url = "{{ url('admin/single_property') }}/" +temp_id;
													window.open(url);
												}
											});
										}else{
