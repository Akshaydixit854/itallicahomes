                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="display nowrap table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                    ...
                                    <tbody>
                                        @if (count($contact_enquireis) > 0)
                                        	@foreach($contact_enquireis as $key => $row)
                                                <tr>
                                                    @if($row->read == 0)
                                                        <td><b>{{ $key + 1 }}</b></td>
                                                        <td><b>{{ $row->name }} </b></td>
                                                        ...
                                                        <td>
                                                            <a href="{{url('')}}/admin/contact_enquiry/read/{{$row->id}}" class="btn btn-success waves-effect" type="submit"><i class="far fa-eye"></i></a>
                                                            <a href="{{url('')}}/admin/contact_enquiry/delete/{{$row->id}}" class="btn btn-dangerwaves-effect" type="submit"><i class="far fa-trash-alt"></i></a>
                                                        </td>
                                                    @else
                                                        <td>{{ $key + 1 }}</td>
                                                        <td>{{ $row->name }} </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <td>
                                                            <a href="{{url('')}}/admin/contact_enquiry/delete/{{$row->id}}" class="btn btn-danger waves-effect" type="submit"><i class="far fa-trash-alt"></i></a>
                                                        </td>
                                                    @endif
                                                </tr>
                                            @endforeach
